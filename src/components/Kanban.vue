...
.column {
  ...
  margin: 25px;
  padding: 10px;
  -webkit-box-shadow: 0px 4px 15px 0px rgba(109, 109, 109, 0.75);
  -moz-box-shadow: 0px 4px 15px 0px rgba(109, 109, 109, 0.75);
  box-shadow: 0px 4px 15px 0px rgba(109, 109, 109, 0.75);
}
.column-header {
  display: flex;
  align-items: center;
